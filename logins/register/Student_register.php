        ...
        <span class="right">
            ...
            <form action="" method="POST" align="center">
                <table>
                    ...
                    <br>
                    <div>
                        <label class='p'">邮箱</label>
                    <input type=" text" name="useremail"id="user_email" style="height: 28px;">
                    </div>
                    <br>
                    <br>
...
$pwd = md5($password);
  ...
  //编写SQL语句
  $sql = "INSERT INTO studentindex (username,password,useremail) VALUES ('$username','$pwd','$useremail')";
  //执行SQL语句
  if ($link->query($sql) === TRUE) 
  {
    echo "注册成功";
    $url = "../login/Studentindex.php";
    echo "<script>";
