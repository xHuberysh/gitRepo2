    ...
    <div id="container">
        ...
        <div id="left">
            <ul>
                ...
                <li><a href="./teacher.php">学生信息查询</a></li>
        ...
        <div id="right">
            <div class="box">
                ...
                <div>
                    <form action="../admin/checkdelete.php"method="POST">
                    <table class="mytable">
                        <tr>
                            <th class="th">序号</th>
                            <th class="th">学号</th>
                        ...
                        while($row = mysqli_fetch_assoc($result))
                        {
                            ...
                            <tr>
                                    ...
                                    <td class="td">
                                                   <a href="../admin/update.php ? id={$row['id']} ">修改</a>
                                                   <a onclick = "javascript:if(!confirm('确认要删除选择的信息吗?')){return false;}"href="../admin/delete.php ? id={$row['id']} ">删除</a></td>
