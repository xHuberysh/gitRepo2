...
<?php
    $link=@mysqli_connect('localhost','root','123456','userinformation') or die('连接或者选择数据库失败');
        ...
        $start = ($page-1)*7;
        $sql = "SELECT * FROM course  limit $start,7" ;
...
<body>
    <div id="container">
        ...
        <div id="left">
            <ul>
                <li><a href="./teacher.php">学生信息管理</a></li>
                <li><a href="./sc.php">选课信息管理</a></li>
            </ul>
        </div>
        <div id="right">
            <div class="box">
                ...
                <div class="bar1">
                    <a href="../course/insertcourse.php"><button class="button">添加选课信息</button></a>
                    <form action="../course/searchcourse.php" method="post">
                ...
                <div>
                    <form action="../course/checkdeletecourse.php"method="POST">
                    <table class="mytable">
                        <tr>
                            <th class="th">序号</th>
                            <th class="th">姓名</th>
                        ...
                        while($row = mysqli_fetch_assoc($result))
                        {
                            ...
                            <td class="td">{$row['grade']}</td>
                                    <td class="td">
                                                   <a href="../course/updatecourse.php ? id={$row['id']} ">修改</a>
                                                   <a onclick = "javascript:if(!confirm('确认要删除选择的信息吗?')){return false;}"href="../course/deletecourse.php ? id={$row['id']} ">删除</a></td>
